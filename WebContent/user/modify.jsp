...
<body>
	...
	<div id="pagecell">
		...
		<div id="formwrapper">
			<form name="frm" action="modifyPassword.do" method="post"
				onsubmit="return check()">
				<fieldset>
					<legend>
						修改密码
						<s:property value="#request.modifyPasswordMsg" />
					</legend>
					<div>
						<label for="username">用户名</label> <input disabled="disabled"
							type="text" name="username" size="18" maxlength="30"
							value="<s:property value="#session.loginuser.username"/>" /> <br />
					</div>
					<div>
					...
					<div>
						<label for="newPassword">新密码</label> <input type="password"
							name="newPassword" size="18" maxlength="30" /> <br />
					</div>
					<div>
						<label for="newPasswordConfirm">密码确认</label> <input
							type="password" name="newPasswordConfirm" size="18"
							maxlength="30" /> <br />
					</div>
					<div class="center">
		...
		<div
			...
			<img
				src='UploadPhotos/<s:property value ="#session.loginuser.id"/>.jpg ' />
			<br />
		</div>
		<div id="siteInfo">
