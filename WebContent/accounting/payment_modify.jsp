...
<body onmousemove="closesubnav(event);">
	...
	<div id="pagecell">
		...
		<div id="content">
			<div class="feature">
				<form name="frm" action="payment_modify.do" method="post"
					...
					<fieldset>
						...
						<div>
							...
							<select name="paymentCategory" style='width: 147px'>
								...
								value='<s:property value="#request.payment.amount"/>' size="18"
								maxlength="30" />
						</div>
						<div>
							<label for="createtime">时间</label> <input type="text"
								value="<s:date name="#request.payment.createTime"/>"
								name="createtime" size="18" maxlength="30" /> <label
								for="place">商家</label> <input type="text" name="place"
								value='<s:property value="#request.payment.place"/>' size="18"
								maxlength="30" /> <label for="remarks">备注</label> <input
								type="text" name="remarks"
								value='<s:property value="#request.payment.remarks"/>' size="18"
								maxlength="30" /> <input type="hidden" name="oldAccount"
								value='<s:property value="#request.payment.account.id"/>'>
							<input type="hidden" name="oldAmount"
								value='<s:property value="#request.payment.amount"/>'>
							<input type="hidden" name="id"
								value='<s:property value="#request.payment.id"/>'> <input
