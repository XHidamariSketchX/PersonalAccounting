...
<body onmousemove="closesubnav(event);">
	...
	<div id="pagecell">
		...
		<div id="content">
			<div class="feature">
				<form name="frm" action="payment_add.do" method="post"
			...
			<div>
				<form action="payment_search.do" method="post">
					<fieldset>
			...
			<div>
				<table class="list_style" border="1">
					<tbody>
						...
						<s:iterator value="#request.paymentList" id="payment">
							...
							<tr>
								...
								<td><s:a href="paymentModify_init.do?id=%{#payment.id}">修改</s:a>
									<s:a href="paymentRemove.do?id=%{#payment.id}">删除</s:a> <s:if
										test="#payment.state==2">
										<s:a href="paymentAddToHistoryPurchase.do?id=%{#payment.id}">加入历史购买</s:a>
									</s:if> <s:else>加入历史购买</s:else></td>
							</tr>
						</s:iterator>
						<tr>
							<td></td>
